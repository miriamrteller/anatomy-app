...
function addPairedBone(name, latinName, aliases, description, metadata) {
    bones.push({
        name: `Left ${name}`,
...
addPairedBone('Parietal Bone', 'Os parietale', ['Parietal'], 'The parietal bones form the superior and lateral walls of the cranium. Each is roughly quadrilateral, curved, with four borders and four angles. They protect the parietal lobes of the cerebral cortex.', {
    boneType: 'flat',
    region: 'Skull - Neurocranium',
...
addPairedBone('Temporal Bone', 'Os temporale', ['Temple bone'], 'The temporal bone is a complex bone forming part of the lateral skull and cranial base. It houses the middle and inner ear structures, contains the mastoid process and styloid process, and forms the temporomandibular joint with the mandible.', {
    boneType: 'irregular',
    region: 'Skull - Neurocranium',
...
// Facial bones (14)
addPairedBone('Nasal Bone', 'Os nasale', ['Nose bone'], 'The nasal bones are two small, oblong bones that form the bridge of the nose. They articulate with each other in the midline, with the frontal bone superiorly, and with the maxillae laterally.', {
    boneType: 'flat',
...
addPairedBone('Lacrimal Bone', 'Os lacrimale', ['Tear bone'], 'The lacrimal bone is the smallest and most fragile bone of the face. It forms part of the medial wall of the orbit and contains the lacrimal fossa, which houses the lacrimal sac for tear drainage.', {
    boneType: 'flat',
    region: 'Skull - Viscerocranium',
    articulations: ['Frontal bone', 'Ethmoid bone', 'Maxilla', 'Inferior nasal concha'],
    bloodSupply: 'Infraorbital artery'
});
addPairedBone('Zygomatic Bone', 'Os zygomaticum', ['Cheekbone', 'Malar bone', 'Zygoma'], 'The zygomatic bone forms the prominence of the cheek and part of the lateral wall and floor of the orbit. It articulates with the frontal, sphenoid, temporal, and maxillary bones, forming the zygomatic arch with the temporal bone.', {
    boneType: 'irregular',
    region: 'Skull - Viscerocranium',
...
addPairedBone('Maxilla', 'Maxilla', ['Upper jaw bone', 'Maxillary bone'], 'The maxilla is a major bone of the face, forming the upper jaw, anterior hard palate, part of the lateral nasal wall, and the floor of the orbit. It contains the maxillary sinus (largest paranasal sinus) and the alveolar process bearing the upper teeth.', {
    boneType: 'irregular',
    region: 'Skull - Viscerocranium',
...
addPairedBone('Palatine Bone', 'Os palatinum', ['Palate bone'], 'The palatine bone is an L-shaped bone forming the posterior part of the hard palate, part of the nasal cavity floor, and part of the orbital floor. It consists of horizontal and perpendicular plates and contributes to the pterygopalatine fossa.', {
    boneType: 'irregular',
    region: 'Skull - Viscerocranium',
...
addPairedBone('Inferior Nasal Concha', 'Concha nasalis inferior', ['Inferior turbinate', 'Inferior nasal turbinate'], 'The inferior nasal concha is a separate bone (unlike the superior and middle conchae which are part of the ethmoid) that forms a curved shelf on the lateral nasal wall. It warms, humidifies, and filters inspired air.', {
    boneType: 'irregular',
    region: 'Skull - Viscerocranium',
...
for (let i = 1; i <= 12; i++) {
    ...
    addPairedBone(`Rib ${i}`, `Costa ${i}`, [`${['First', 'Second', 'Third', 'Fourth', 'Fifth', 'Sixth', 'Seventh', 'Eighth', 'Ninth', 'Tenth', 'Eleventh', 'Twelfth'][i - 1]} rib`], `Rib ${i} is a ${ribType} that ${attachment}. It articulates with thoracic vertebrae T${i}${i > 1 && i <= 10 ? ` and T${i - 1}` : ''} posteriorly. Ribs protect thoracic organs and assist in breathing mechanics.`, {
        boneType: 'flat',
...
// ==================== PECTORAL GIRDLE ====================
addPairedBone('Clavicle', 'Clavicula', ['Collarbone'], 'The clavicle is a long bone that serves as a strut between the scapula and sternum. It is the most commonly fractured bone in the body. It provides attachment for muscles, protects underlying neurovascular structures, and transmits force from the upper limb to the axial skeleton.', {
    boneType: 'long',
...
addPairedBone('Scapula', 'Scapula', ['Shoulder blade'], 'The scapula is a triangular flat bone on the posterior thorax. Key features include the spine, acromion, coracoid process, glenoid fossa (for humeral articulation), and fossae for rotator cuff muscles. It provides attachment for 17 muscles and allows great mobility of the upper limb.', {
    boneType: 'flat',
    region: 'Pectoral Girdle',
...
addPairedBone('Radius', 'Radius', ['Radial bone'], 'The radius is the lateral bone of the forearm (thumb side). Proximally it has a disc-shaped head that rotates on the capitulum. Distally it is broad, articulating with carpal bones and forming the main wrist joint. The radius rotates around the ulna during pronation and supination.', {
    boneType: 'long',
...
addPairedBone('Ulna', 'Ulna', ['Ulnar bone'], 'The ulna is the medial bone of the forearm (pinky side). Proximally it has the olecranon (elbow tip), trochlear notch (humerus articulation), and coronoid process. It is the main forearm bone at the elbow but has minimal direct wrist articulation, connecting via the triangular fibrocartilage complex.', {
    boneType: 'long',
    region: 'Upper Limb - Forearm',
...
// ==================== PELVIS ====================
addPairedBone('Ilium', 'Os ilium', ['Iliac bone'], 'The ilium is the largest part of the hip bone, forming the superior portion. It features the iliac crest (palpable at the waist), anterior superior iliac spine (ASIS), and the iliac fossa. It articulates with the sacrum at the sacroiliac joint and fuses with the ischium and pubis at the acetabulum.', {
    boneType: 'flat',
    region: 'Pelvis',
...
addPairedBone('Ischium', 'Os ischii', ['Seat bone', 'Ischial bone'], 'The ischium forms the posteroinferior part of the hip bone. The ischial tuberosity bears weight when sitting and is the origin of the hamstrings. The ischial spine is a landmark for pudendal nerve block. The lesser sciatic notch is inferior to the spine.', {
    boneType: 'irregular',
    region: 'Pelvis',
...
addPairedBone('Pubis', 'Os pubis', ['Pubic bone'], 'The pubis forms the anteromedial part of the hip bone. The two pubic bones meet at the pubic symphysis, a cartilaginous joint. The superior pubic ramus and inferior pubic ramus frame the obturator foramen. The pubic tubercle is a key landmark for inguinal anatomy.', {
    boneType: 'irregular',
    region: 'Pelvis',
...
// ==================== LOWER LIMB ====================
addPairedBone('Femur', 'Femur', ['Thigh bone'], 'The femur is the longest and strongest bone in the body. Proximally it has the head (hip joint), neck (common fracture site), and greater and lesser trochanters. The shaft is bowed anteriorly with the linea aspera posteriorly. Distally, the medial and lateral condyles articulate with the tibia.', {
    boneType: 'long',
...
addPairedBone('Patella', 'Patella', ['Kneecap'], 'The patella is the largest sesamoid bone, embedded in the quadriceps tendon. It protects the knee joint anteriorly and improves the mechanical advantage of the quadriceps for knee extension by increasing the moment arm. It articulates with the femoral trochlea.', {
    boneType: 'sesamoid',
...
addPairedBone('Tibia', 'Tibia', ['Shinbone', 'Shin bone'], 'The tibia is the larger, medial bone of the leg, bearing most of the body weight. Proximally, the medial and lateral condyles form the tibial plateau (knee joint). The tibial tuberosity is the patellar tendon attachment. The medial malleolus forms the medial ankle prominence.', {
    boneType: 'long',
...
addPairedBone('Fibula', 'Fibula', ['Calf bone'], 'The fibula is the slender, lateral bone of the leg. It bears little weight but provides muscle attachment and forms the lateral malleolus (lateral ankle prominence). The common fibular nerve wraps around its neck and is vulnerable to injury there.', {
    boneType: 'long',
    region: 'Lower Limb - Leg',
...
//# sourceMappingURL=generate-bones.js.map